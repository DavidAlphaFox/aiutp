...
-define(OUTGOING_BUFFER_MAX_SIZE, 16).
-define(REORDER_SACK_MAX_SIZE,255).
...
%us
-define(MAX_RECV_IDLE_TIME,300000000).
-define(MAX_SEND_IDLE_TIME, 50000000).
-define(MAX_CLOSING_WAIT,    3000000).
% us
